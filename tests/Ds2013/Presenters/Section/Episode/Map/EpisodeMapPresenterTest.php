...
class EpisodeMapPresenterTest extends TestCase
{
    ...
    private function getPresenterWithPanels($onlyTxPanel = false, $onlyMorePanel = false)
    {
        ...
        if (!$onlyMorePanel && !$onlyTxPanel) {
            ...
            return new EpisodeMapPresenter($router, $liveBroadcastHelper, $streamUrlHelper, $playTranslationsHelper, $noTleoprogramme, $upcomingBroadcast, $lastOnBroadcast, null, [], null, null, null);
        }
        ...
        if ($onlyMorePanel && $onlyTxPanel) {
            ...
            return new EpisodeMapPresenter($router, $liveBroadcastHelper, $streamUrlHelper, $playTranslationsHelper, $episode, $upcomingBroadcast, $lastOnBroadcast, null, [], null, null, null);
        }
