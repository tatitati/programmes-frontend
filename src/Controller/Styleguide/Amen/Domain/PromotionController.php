...
class PromotionController extends BaseController
{
    ...
    {
        return $this->renderWithChrome('styleguide/amen/domain/promotion.html.twig', [
    ...
    private function buildPromotionsOfDifferentTypes()
    {
        return [
            'Promotion Image' => [
                'item' => PromotionBuilder::ofImage()->build(),
                'render_options' => [],
            ],
            'Promotion of core entity' => [
                    'item' => PromotionBuilder::ofCoreEntity()->build(),
                    'render_options' => [],
            ],
        ];
    }
    ...
    {
        $defaultPromotion = PromotionBuilder::any()->build();
