...
class MapPresenter extends Presenter
{
    ...
    public function __construct(Request $request, ProgrammeContainer $programme, int $upcomingEpisodesCount, ?CollapsedBroadcast $mostRecentBroadcast, array $options = [])
    {
    ...
    {
        return new ProgrammeInfoPresenter($this->programme, [
            'coming_soon_takeover' => $this->comingSoonTakeover,
            'world_news' => $this->isWorldNews(),
            'must_show_tx_column' => $this->mustShowTxColumn,
